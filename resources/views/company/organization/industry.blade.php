<x-company-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 flex justify-end">
            <x-my-nav-link :href="route('company.industry.create')">
                {{ __('業界作成') }}
            </x-my-nav-link>
        </div>
                ...
                <li class=" py-2 sm:py-4 lg:py-8">
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                      <div class="flex items-center justify-between rounded-lg bg-gray-100 p-2 sm:flex-row md:p-8">
                            <p class="text-xl font-bold text-indigo-500 md:text-2xl">{{ $industry->name }}</p>

                            <div class="">
                                <x-my-nav-link :href="route('company.industry.show',[ $industry->id ])">
                                    {{ __('詳細') }}
                                </x-my-nav-link>
                                <x-my-nav-link :href="route('company.industry.edit',[ $industry->id ])">
                                    {{ __('編集') }}
                                </x-my-nav-link>
