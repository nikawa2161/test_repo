                ...
                <li class=" py-2 sm:py-4 lg:py-8">
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                      <div class="flex items-center justify-between rounded-lg bg-gray-100 p-2 sm:flex-row md:p-8">
                        <div class="">
                            <p class="text-xl font-bold text-indigo-500 md:text-2xl">特徴名：{{ $feature->name }}</p>
                            <p class="text-xl font-bold text-indigo-500 md:text-2xl">求人名：{{ $feature->offer->title }}</p>
                        </div>
                            <div class="">
